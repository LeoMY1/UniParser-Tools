...
def _write_patent_artifacts(
    ...
    *,
    ...
    return {
        ...
        "general_formula_task_packets_path": str(formulas.task_packets_path),
        "general_formula_evidence_ledger_path": str(formulas.evidence_ledger_path),
        "general_formula_agent_contexts_path": str(formulas.agent_contexts_path),
        ...
        "formula_structure_count": formulas.structure_count,
        ...
        "formula_task_packet_count": formulas.packet_count,
